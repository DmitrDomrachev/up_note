...
///
/// This class encapsulates the overall onboarding data including the number of pages
/// and the details of each onboarding page.
@JsonSerializable()
class OnboardingDto {
  ...
  /// A list of [OnboardingPageDto] objects representing each page in the onboarding.
...
class OnboardingPageDto {
  ...
  /// A brief description of what the user will learn or experience on this page.
